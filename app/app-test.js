...
describe('aacApp.main module', () => {
    ...
    beforeEach(() => {
        ...
        ots = {
            init: function() {
                return {run: function() {}, onResolutionChanged: function() {}, kv: {}, child: {}}
            }
        };
    });
    ...
    describe('map', () => {
        it('should be expected', () => {
            ...
            appCtrl.initExtendedSymbols();
            expect(appCtrl.$scope.global.extendedArray).toBeDefined();
            expect(appCtrl.$scope.global.extendedTitleArray.length).toBe(22);
            expect(appCtrl.$scope.global.extendedSlugArray.length).toBe(22);
            ...
            appCtrl.initExtendedSymbols();
            expect(appCtrl.$scope.global.extendedArray.length).toBe(128);
            expect(appCtrl.$scope.global.extendedTitleArray.length).toBe(128);
            expect(appCtrl.$scope.global.extendedSlugArray.length).toBe(128);
        });
    });
