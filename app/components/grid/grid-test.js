...
describe('aacApp.grid module', () => {
	...
	describe('grid controller', () => {
		it('should be defined', () => {
			...
			gridCtrl = $controller(GridController, { $scope: {}, $global: g, $timeout: $timeout, TTSManager: tts, EventManager: event, LSManager: ls, ConjunctionManager: cm });
